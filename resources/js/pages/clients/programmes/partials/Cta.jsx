                ...
                <div className="flex flex-col justify-between rounded-2xl bg-[var(--color-alpha)]/90 p-6 text-white shadow-lg md:flex-row md:items-center md:gap-6">
                    <div>
                        <h2 className="text-xl font-semibold md:text-2xl">
                            <TransText
                                fr="Participez à nos programmes"
                                ar="انخرطوا في برامجنا"
                                en="Join our programs"
                            />
                        </h2>
                        <p className="mt-3 max-w-2xl text-sm text-white/90 md:text-base">
                            <TransText
                                fr="Rejoignez-nous et contribuez à construire une société plus juste et égalitaire pour toutes et tous."
                                ar="انضموا إلينا وساهموا في بناء مجتمع أكثر عدالة ومساواة للجميع."
                                en="Join us and help build a fairer and more equal society for everyone."
                            />
                        </p>
                    </div>
                    <div className="mt-5 flex flex-wrap gap-3 md:mt-0">
                        ...
                        >
                            <TransText fr="Demander de l'aide" ar="طلب المساعدة" en="Request support" />
                        </Link>
                    </div>
                </div>
            </section>
